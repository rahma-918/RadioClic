...
const getUserInfoFromBackend = async () => {
  try {
    ...
    if (data) {
      // Format date of birth before setting in state
      const formattedDate = formatDate(data.datedenaissance);
      setUserInfo({
        ...data,
        // Update datedenaissance with formatted date
        ...
        <section id="edit_profile">
            ...
            <form onSubmit={(e) => {
               ...
               updateUserInformation();
                ...
                <input type="date" id="datedenaissance" name="datedenaissance" value={userInfo.datedenaissance} onChange={(e) => setUserInfo({...userInfo, datedenaissance: e.target.value})} /><br></br>
